...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self)
    {
        self=(IsIphone5)?[super initWithNibName:@"PrivacyPolicyViewBig" bundle:nil]:[super initWithNibName:@"PrivacyPolicyView" bundle:nil];
    }
    return self;
}
...
-(void)PrepareScreen
{
    ...
    [SVBack setContentSize:CGSizeMake(320.0f, 1200.0f)];
