...
#define TOP_HEIGHT 51
#define DAYS_HEADER_HEIGHT 38
...
@property (nonatomic, strong) TPDateItem *dateItem;
...
- (void)setDate:(NSDate *)date
{
    ...
    if (date)
    {
        ...
        [self setTitleColor:UIColorFromRGB(0xE8661C) forState:UIControlStateNormal];
    }
    else
    {
...
{
    return [self initWithStartDay:firstDay frame:CGRectMake(0, 0, 280.0f, 308.0f)];
}

- (void)_init:(TPCalendarStartDay)firstDay
{
    ...
    [prevButton setImage:[UIImage imageNamed:@"calendar-arrow-left.png"] forState:UIControlStateNormal];
    ...
    [nextButton setImage:[UIImage imageNamed:@"calendar-arrow-right.png"] forState:UIControlStateNormal];
...
- (void)layoutSubviews
{
    ...
    self.calendarContainer.frame = CGRectMake(CALENDAR_MARGIN, 60.0f, containerWidth, containerHeight);
    ...
    while ([date laterDate:endDate] != date)
    {
        ...
        TPDateItem *item = [[TPDateItem alloc] init];
        item.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageNamed:@"calendar_small_box.png"]];
        
        item.textColor = UIColorFromRGB(0xE8661C);
        item.selectedTextColor = UIColorFromRGB(0xE8661C);
        ...
        {
            item.textColor = UIColorFromRGB(0xFFBF33);
        }
        ...
        if (self.selectedDate && [self date:self.selectedDate isSameDayAsDate:date])
        {
            ...
            dateButton.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageNamed:@"calendar_date_selected.png"]];
        }
        else
        {
...
- (void)setCalendarStartDay:(TPCalendarStartDay)calendarStartDay
{
...
- (void)_setDefaultStyle
{
    ...
    [self setTitleFont:[UIFont fontWithName:@"papyrus" size:18.0f]];
    [self setTitleColor:UIColorFromRGB(0xE8661C)];
    
    [self setDayOfWeekFont:[UIFont fontWithName:@"papyrus" size:12.0f]];
    [self setDayOfWeekTextColor:UIColorFromRGB(0xE8661C)];
    
    [self setDateFont:[UIFont fontWithName:@"papyrus" size:20.0f]];
...
{
    [self.prevButton setImage:[TPCalendarView _imageNamed:@"calendar-arrow-left.png" withColor:color] forState:UIControlStateNormal];
    [self.nextButton setImage:[TPCalendarView _imageNamed:@"calendar-arrow-right.png" withColor:color] forState:UIControlStateNormal];
}
